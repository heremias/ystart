...
namespace Drupal\static_deployer_s3\Form;
...
class SettingsForm extends ConfigFormBase {
  ...
  public function getFormId() {
    return 'static_deployer_s3_settings';
  }
  ...
  protected function getEditableConfigNames() {
    return ['static_deployer_s3.settings'];
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    $config = $this->config('static_deployer_s3.settings');
    ...
    $form['credentials'] = [
      ...
      '#description' => $this->t(
        "To set access and secret key you must use \$settings['static_deployer_s3.access_key'] and \$settings['static_deployer_s3.secret_key'] in your site's settings.php file.<br/>Submitting this form without adding your credentials will throw an error."
      ),
    ];
    ...
    $form['bucket'] = [
      ...
      '#description' => $this->t('Your site will be uploaded to this bucket.'),
      '#required' => TRUE,
  ...
  public function validateForm(array &$form, FormStateInterface $form_state) {
    $accessKey = Settings::get('static_deployer_s3.access_key');
    $secretKey = Settings::get('static_deployer_s3.secret_key');
